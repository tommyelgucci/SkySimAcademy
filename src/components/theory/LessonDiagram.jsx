  ...
  return (
    ...
    >
      ...
      <g transform="rotate(-16 250 118)">
        ...
        <path
          d="M 170 118 C 190 96, 250 92, 300 108 C 322 114, 336 118, 344 118
  ...
  return (
    ...
    >
      ...
      <line
        ...
        strokeWidth="3"
        strokeDasharray="8 5"
        markerStart="url(#ax-roll)"
        markerEnd="url(#ax-roll)"
      />
      ...
      <line
        ...
        strokeWidth="3"
        strokeDasharray="8 5"
        markerStart="url(#ax-pitch)"
        markerEnd="url(#ax-pitch)"
      />
  ...
  return (
    ...
    >
      ...
      <line
        ...
        stroke="#ffb703"
        strokeWidth="3"
        markerStart="url(#gr-alt)"
        markerEnd="url(#gr-alt)"
      />
      ...
      <line
        ...
        stroke="#35c759"
        strokeWidth="3"
        markerStart="url(#gr-dist)"
        markerEnd="url(#gr-dist)"
      />
    ...
    >
      ...
      {[
        ...
        <g key={load.x}>
          ...
          <line
            x1="60"
            y1={load.x === 150 ? 140 : 164}
            x2={load.x}
            y2={load.x === 150 ? 140 : 164}
            stroke={ARM}
            strokeWidth="2.5"
            markerStart="url(#mb-arm)"
            markerEnd="url(#mb-arm)"
          />
          <text
            x={(60 + load.x) / 2}
            y={load.x === 150 ? 134 : 158}
            textAnchor="middle"
            fill={ARM}
            fontSize="12"
            fontWeight="700"
